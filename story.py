def begin_story():
	user_response = 0
	print("you have decided to go with daine after school to practice. What do you do next go with daine. He says hes going to throw some passes outside. What do you do next?")
